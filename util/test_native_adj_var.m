function [native_adj_scores, corr_val, virtual_resect_mat] = test_native_adj_var(all_patient_conn, pt_mni, patient_roi, atlas_conn, atlas_std, all_inds, test_band, var_method)
        ...
        for j = 1:num_elecs
            ...
            if region1==region2
                if i==j
                    ...
                    % expected std
                    exp_std = 0.0039-0.0012*inter_elec_dist; % code this better
